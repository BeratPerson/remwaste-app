...
export default function SkipSelectorPage() {
  ...
  const { skips, loading, error } = useSelector((state: RootState) => state.skips);
              ...
              <div className="flex items-center gap-6">
                <div className="text-right">
                  <span className="text-3xl font-extrabold text-[var(--primary)]">
                    £{(selectedSkip.price_before_vat + selectedSkip.price_before_vat * selectedSkip.vat / 100 + (selectedSkip.transport_cost || 0)).toLocaleString()}
                  </span>
